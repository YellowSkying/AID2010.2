...
class HouseModel:
    ...
    def __str__(self):
        return (f"{self.id} {self.title} {self.community} {self.years} {self.house_type}"
                f"{self.area} {self.floor} {self.description} {self.total_price} {self.unit_price} {self.follow_info}")
